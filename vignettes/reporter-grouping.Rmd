...
With the above modification, the group *"Infections and infestations"* is still split
because it is a large group, and there is no way to avoid splitting it across
multiple pages.  However, the other breaks have all been avoided by moving 
groups to the next page.  In this way, the report looks nicer and 
...
for all of group B. To keep group B together, it is therefore moved to 
page 2.

After group B moves to page 2, the remaining space is not enough for all of group C.
And we cannot move all of group C to page 3, because it is too big. 

As a result, group C will be split between pages 2 and 3. However, because we
engaged group cohesion for both Group1 and Group2,
**reporter** will try to keep Group2 on the same page. Therefore, all
of group "Flower C2" is moved to page 3.
