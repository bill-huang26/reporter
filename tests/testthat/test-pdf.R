...
test_that("pdf36: Custom page size works as expected.", {
  
  fp <- file.path(base_path, "pdf/test36.pdf")
...
test_that("pdf37: Stub indent.", {
  
  
  fp <- file.path(base_path, "pdf/test37.pdf")
...
test_that("pdf39: Table with blank_before works as expected.", {
  
  if (dev == TRUE) {
    
    
    fp <- file.path(base_path, "pdf/test39.pdf")
...
test_that("pdf40: Three level stub and indentation work as expected.", {
  
  if (dev == TRUE) {
    fp <- file.path(base_path, "pdf/test40.pdf")
...
test_that("pdf48: Multiple dedupe works as expected.", {
  
  if (dev == TRUE) {
    fp <- file.path(base_path, "pdf/test48.pdf")
...
test_that("pdf49: Empty page_by works as expected.", {
  
  if (dev == TRUE) {
    fp <- file.path(base_path, "pdf/test49.pdf")
...
test_that("pdf50: Numeric page_by works as expected.", {
  
  if (dev == TRUE) {
    fp <- file.path(base_path, "pdf/test50.pdf")
...
test_that("pdf51 Percentage column widths work as expected.", {
  
  if (dev == TRUE) {
    fp <- file.path(base_path, "pdf/test51.pdf")
